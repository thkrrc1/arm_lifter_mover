...
def interpret_robot_model(driver_settings_file, robot_pkg):
    robot_description_content = Command([
        ...
        " ",
        PathJoinSubstitution([robot_pkg, "model", "arm_lifter_mover.urdf.xacro"]),
        " ",
        "driver_settings:=",
...
def launch_setup(context, *args, **kwargs):
    ...
    priority_controllers = ["mechanum_controller", "joint_state_broadcaster", "lifter_controller", "hand_controller", "arm_controller"]
